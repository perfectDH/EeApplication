            ...
            if ($("#change").text() == "修改") {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //更新成功，刷新页面
                        $("#message").parent().prev().text($("#message").val());
        ...
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="showAddress.action">收货地址</a></li>
                    <li><a href="#">缺货登记</a></li>
                    <li><a href="#">跟踪订单</a></li>
                </ul>
            </div>
        ...
        <div class="m_right">
            ...
            <table border="0" class="acc_tab" style="width:870px;" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td name="idNo" id="idNo">${sessionScope.User.userId}</td>
                </tr>
                <tr>
                    <td class="td_l b_none">身份证号：</td>
                    <td>${sessionScope.user.message}</td>
                    <td class="modify_info"><input type="text" name="message" id="message"
                                                   value="${sessionScope.user.idNo}"/></td>
                </tr>
                <tr>
                    <td class="td_l b_none">电 话：</td>
                    <td>${sessionScope.User.mobile}</td>
                    <td class="modify_info"><input type="text" name="mobile" id="mobile"
                                                   value="${sessionScope.user.mobile}"/></td>
                </tr>
                <tr>
                    <td class="td_l">邮 箱：</td>
                    <td>${sessionScope.User.email}</td>
                    <td class="modify_info"><input type="text" name="email" id="email"
                                                   value="${sessionScope.user.email}"/></td>
                </tr>
                <tr>
                    <td class="td_l b_none">注册时间：</td>
                    <td><fmt:formatDate value="${sessionScope.User.createTime}" pattern="yyyy/MM/dd"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>${sessionScope.User.inviteName}</td>
                </tr>
                <tr>
