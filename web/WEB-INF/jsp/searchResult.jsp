<%@ page language="java" contentType="text/html; charset=utf-8" import="java.util.*,com.shoppingstreet.entity.*"
         pageEncoding="utf-8" %>
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    %>
                    <li>
                        <div class="img"><a href="#"><img src="images/<%=product.getFileName() %>" width="210"
                                                          height="185"/></a></div>
                        <div class="price">
