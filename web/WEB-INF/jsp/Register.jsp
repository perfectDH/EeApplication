            ...
            <form action="register.action" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><input name="visitname" type="text" value="" class="l_mem"/></td>
                    </tr>
                    <tr height="50">
                        <td align="right">邀请人ID号 &nbsp;</td>
                        <td><input name="visitid" type="text" value="" class="l_num"/></td>
                    </tr>
                    <tr height="50">
                	...
                	<span style="font-family:'宋体';" class="fl">
                    	<label class="r_rad"><input type="checkbox" value="true"/></label><label class="r_txt">我已阅读并接受《用户协议》</label>
                    </span>
                        </td>
                    </tr>
                    <tr height="60">
